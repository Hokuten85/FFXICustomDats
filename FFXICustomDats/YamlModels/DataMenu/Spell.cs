...
namespace FFXICustomDats.YamlModels.DataMenu
{
    public class Spell : Entry
    {
        ...
        [YamlMember(Alias = "skill_type", ApplyNamingConventions = false, Order = 4)]
        public SkillType SkillType { get; set; }

        [YamlMember(Alias = "cast_time", ApplyNamingConventions = false, Order = 5)]
        public long? CastTime { get; set; }

        [YamlMember(Alias = "recast_time", ApplyNamingConventions = false, Order = 6)]
        public long? RecastTime { get; set; }

        [YamlMember(Alias = "level_required", ApplyNamingConventions = false, Order = 7)]

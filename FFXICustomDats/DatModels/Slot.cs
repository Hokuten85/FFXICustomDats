...
{
    public enum Slot { Back, Body, Ears, Feet, Hands, Head, Legs, Neck, Rings, Sub, Waist };
    ...
    public partial class SlotConversion
    {
        ...
        {
            //{ SLOTTYPE.SLOT_MAIN, Slot.WallHanging },
            { SLOTTYPE.SLOT_SUB, Slot.Sub },
            //{ SLOTTYPE.SLOT_RANGED, Slot.PartyMember },
            //{ SLOTTYPE.SLOT_AMMO, Slot.Enemy },

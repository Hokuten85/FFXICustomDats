...
{
    public enum ValidTarget { Corpse, Enemy, Object, PartyMember, SelfTarget };
    ...
    public partial class ValidTargetConversion
    {
        ...
        private readonly static Dictionary<TARGETTYPE, ValidTarget> ValidTargetDict = new()
        {
            ...
            //{ TARGETTYPE.TARGET_PLAYER_ALLIANCE, ValidTarget.CanSendPol },
        ...
        public static List<ValidTarget> ConvertBitValidTargetsToYaml(ushort validTargets)
        {
            ...
            foreach (var target in ValidTargetDict.Keys)
            {
                ...
                {
                    if (ValidTargetDict.TryGetValue(target, out ValidTarget validTarget))
                    {

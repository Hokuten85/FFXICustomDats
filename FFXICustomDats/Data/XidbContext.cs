...
public partial class XidbContext : DbContext
{
    ...
    public virtual DbSet<AuditBazaar> AuditBazaars { get; set; }

    public virtual DbSet<AuditChat> AuditChats { get; set; }

    public virtual DbSet<AuditDbox> AuditDboxes { get; set; }

    public virtual DbSet<AuditGm> AuditGms { get; set; }

    public virtual DbSet<AuditTrade> AuditTrades { get; set; }
    ...
    public virtual DbSet<BcnmRecord> BcnmRecords { get; set; }
    ...
    public virtual DbSet<CharFishingContestHistory> CharFishingContestHistories { get; set; }
    ...
    public virtual DbSet<CharMod> CharMods { get; set; }
    ...
    public virtual DbSet<FishingContest> FishingContests { get; set; }

    public virtual DbSet<FishingContestEntry> FishingContestEntries { get; set; }
    ...
    public virtual DbSet<SynergyRecipe> SynergyRecipes { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<AccountsSession>(entity =>
        {
            ...
            entity.Property(e => e.LastZoneoutTime)
                .HasDefaultValueSql("current_timestamp()")
                .HasColumnType("datetime")
                .HasColumnName("last_zoneout_time");
        ...
        modelBuilder.Entity<AuditBazaar>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PRIMARY");

            entity
                .ToTable("audit_bazaar")
                .HasCharSet("utf8mb3")
        ...
        modelBuilder.Entity<AuditDbox>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PRIMARY");
            ...
            entity.HasIndex(e => e.Sender, "charid");
        ...
        modelBuilder.Entity<AuditTrade>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PRIMARY");
        ...
        modelBuilder.Entity<AuditVendor>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PRIMARY");

            entity
                .ToTable("audit_vendor")
                .HasCharSet("utf8mb3")
                .UseCollation("utf8mb3_general_ci");
        ...
        modelBuilder.Entity<BcnmRecord>(entity =>
        {
            entity.HasKey(e => e.BcnmId).HasName("PRIMARY");

            entity.ToTable("bcnm_records");
        ...
        modelBuilder.Entity<XidbEntities.Char>(entity =>
        {
            ...
            entity.Property(e => e.PosPrevzonelineid)
                .HasColumnType("int(10) unsigned")
                .HasColumnName("pos_prevzonelineid");
        ...
        modelBuilder.Entity<CharEffect>(entity =>
        {
            ...
            entity.Property(e => e.Sourcetypeparam)
                .HasColumnType("int(10) unsigned")
                .HasColumnName("sourcetypeparam");
        ...
        modelBuilder.Entity<CharFishingContestHistory>(entity =>
        {
            entity.HasKey(e => e.Charid).HasName("PRIMARY");

            entity
                .ToTable("char_fishing_contest_history")
                .HasCharSet("utf8mb3")
                .UseCollation("utf8mb3_general_ci");
            ...
            entity.Property(e => e.Charid)
                ...
                .HasColumnType("int(10) unsigned")
                .HasColumnName("charid");
            entity.Property(e => e.ContestRank1)
                .HasColumnType("smallint(3) unsigned")
                .HasColumnName("contest_rank_1");
            entity.Property(e => e.ContestRank2)
                .HasColumnType("smallint(3) unsigned")
                .HasColumnName("contest_rank_2");
            entity.Property(e => e.ContestRank3)
                .HasColumnType("smallint(3) unsigned")
                .HasColumnName("contest_rank_3");
            entity.Property(e => e.ContestRank4)
                .HasColumnType("smallint(3) unsigned")
                .HasColumnName("contest_rank_4");
        });
        ...
        modelBuilder.Entity<CharMod>(entity =>
        {
            entity.HasKey(e => new { e.Charid, e.Modid })
                .HasName("PRIMARY")
                .HasAnnotation("MySql:IndexPrefixLength", new[] { 0, 0 });

            entity.ToTable("char_mods");
        ...
        modelBuilder.Entity<CharPoint>(entity =>
        {
            ...
            entity.Property(e => e.ApollyonUnits)
                .HasColumnType("int(10) unsigned")
                .HasColumnName("apollyon_units");
            ...
            entity.Property(e => e.BloodshedPlans)
                .HasColumnType("smallint(5) unsigned")
                .HasColumnName("bloodshed_plans");
            ...
            entity.Property(e => e.DomainPoints)
                .HasColumnType("int(10) unsigned")
                .HasColumnName("domain_points");
            entity.Property(e => e.DomainPointsDaily)
                .HasColumnType("int(10) unsigned")
                .HasColumnName("domain_points_daily");
            ...
            entity.Property(e => e.Gallimaufry)
                .HasColumnType("int(10) unsigned")
                .HasColumnName("gallimaufry");
            ...
            entity.Property(e => e.IsAccolades)
                .HasColumnType("smallint(5) unsigned")
                .HasColumnName("is_accolades");
            ...
            entity.Property(e => e.MogSegments)
                .HasColumnType("int(10) unsigned")
                .HasColumnName("mog_segments");
            ...
            entity.Property(e => e.PrimacyPlans)
                .HasColumnType("smallint(5) unsigned")
                .HasColumnName("primacy_plans");
            ...
            entity.Property(e => e.RitualisticPlans)
                .HasColumnType("smallint(5) unsigned")
                .HasColumnName("ritualistic_plans");
            ...
            entity.Property(e => e.TemenosUnits)
                .HasColumnType("int(10) unsigned")
                .HasColumnName("temenos_units");
            ...
            entity.Property(e => e.TutelaryPlans)
                .HasColumnType("smallint(5) unsigned")
                .HasColumnName("tutelary_plans");
            entity.Property(e => e.UmbragePlans)
                .HasColumnType("smallint(5) unsigned")
                .HasColumnName("umbrage_plans");
        ...
        modelBuilder.Entity<FishingContest>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("fishing_contest")
                .HasCharSet("utf8mb3")
                .UseCollation("utf8mb3_general_ci");
            ...
            entity.Property(e => e.Nextstagetime)
                .HasColumnType("int(10) unsigned")
        ...
        modelBuilder.Entity<FishingContestEntry>(entity =>
        {
            entity.HasKey(e => e.Charid).HasName("PRIMARY");

            entity
                .ToTable("fishing_contest_entries")
                .HasCharSet("utf8mb3")
                .UseCollation("utf8mb3_general_ci");
            ...
            entity.Property(e => e.Contestrank)
                .HasColumnType("tinyint(2) unsigned")
                .HasColumnName("contestrank");
            entity.Property(e => e.Fishrank)
                .HasColumnType("tinyint(2) unsigned")
                .HasColumnName("fishrank");
            entity.Property(e => e.Mjob)
                .HasColumnType("tinyint(2) unsigned")
                .HasColumnName("mjob");
        ...
        modelBuilder.Entity<ItemEquipment>(entity =>
        {
            ...
            entity.Property(e => e.Rslot)
                .HasColumnType("smallint(5) unsigned")
                .HasColumnName("rslot");
            entity.Property(e => e.Rslotlook)
                .HasColumnType("smallint(5) unsigned")
                .HasColumnName("rslotlook");
        ...
        modelBuilder.Entity<MobResistance>(entity =>
        {
            ...
            entity.Property(e => e.ResistId)
                ...
                .HasColumnType("smallint(4) unsigned")
                .HasColumnName("resist_id");
            entity.Property(e => e.BindResRank)
                .HasColumnType("smallint(3)")
                .HasColumnName("bind_res_rank");
            entity.Property(e => e.BlindResRank)
                .HasColumnType("smallint(3)")
                .HasColumnName("blind_res_rank");
            ...
            entity.Property(e => e.DarkSleepResRank)
                .HasColumnType("smallint(3)")
                .HasColumnName("dark_sleep_res_rank");
            ...
            entity.Property(e => e.LightSleepResRank)
                .HasColumnType("smallint(3)")
                .HasColumnName("light_sleep_res_rank");
            ...
            entity.Property(e => e.Name)
                .HasColumnType("tinytext")
                .HasColumnName("name");
            entity.Property(e => e.ParalyzeResRank)
                .HasColumnType("smallint(3)")
            ...
            entity.Property(e => e.PoisonResRank)
                .HasColumnType("smallint(3)")
                .HasColumnName("poison_res_rank");
            entity.Property(e => e.SilenceResRank)
                .HasColumnType("smallint(3)")
        ...
        modelBuilder.Entity<MobSkill>(entity =>
        {
            ...
            entity.Property(e => e.MobSkillAoeRadius)
                .HasColumnType("float(3,1)")
                .HasColumnName("mob_skill_aoe_radius");
        ...
        {
            entity.HasKey(e => new { e.Zoneid, e.Spawnsetid })
                .HasName("PRIMARY")
                .HasAnnotation("MySql:IndexPrefixLength", new[] { 0, 0 });

            entity.ToTable("mob_spawn_sets");

            entity.Property(e => e.Zoneid)
                .HasColumnType("smallint(3)")
                .HasColumnName("zoneid");
            entity.Property(e => e.Spawnsetid)
                .HasColumnType("tinyint(3)")
                .HasColumnName("spawnsetid");
        ...
        modelBuilder.Entity<SynergyRecipe>(entity =>
        {
            ...
            entity.ToTable("synergy_recipes");

            entity.Property(e => e.Id)
                .HasColumnType("mediumint(5) unsigned")
                .HasColumnName("id");
            entity.Property(e => e.CostDarkFewell)
                .HasColumnType("smallint(5) unsigned")
                .HasColumnName("cost_dark_fewell");
            entity.Property(e => e.CostEarthFewell)
                .HasColumnType("smallint(5) unsigned")
                .HasColumnName("cost_earth_fewell");
            entity.Property(e => e.CostFireFewell)
                .HasColumnType("smallint(5) unsigned")
                .HasColumnName("cost_fire_fewell");
            entity.Property(e => e.CostIceFewell)
                .HasColumnType("smallint(5) unsigned")
                .HasColumnName("cost_ice_fewell");
            entity.Property(e => e.CostLightFewell)
                .HasColumnType("smallint(5) unsigned")
                .HasColumnName("cost_light_fewell");
            entity.Property(e => e.CostLightningFewell)
                .HasColumnType("smallint(5) unsigned")
                .HasColumnName("cost_lightning_fewell");
            entity.Property(e => e.CostWaterFewell)
                .HasColumnType("smallint(5) unsigned")
                .HasColumnName("cost_water_fewell");
            entity.Property(e => e.CostWindFewell)
                .HasColumnType("smallint(5) unsigned")
                .HasColumnName("cost_wind_fewell");
            ...
            entity.Property(e => e.PrimaryRank)
                .HasColumnType("tinyint(2) unsigned")
                .HasColumnName("primary_rank");
            ...
            entity.Property(e => e.ResultQty)
                .HasColumnType("tinyint(2) unsigned")
                .HasColumnName("resultQty");
            entity.Property(e => e.SecondaryRank)
                .HasColumnType("tinyint(2) unsigned")
                .HasColumnName("secondary_rank");
            entity.Property(e => e.SecondarySkill)
                .HasColumnType("tinyint(2) unsigned")
                .HasColumnName("secondary_skill");
            entity.Property(e => e.TertiaryRank)
                .HasColumnType("tinyint(2) unsigned")
                .HasColumnName("tertiary_rank");
            entity.Property(e => e.TertiarySkill)
                .HasColumnType("tinyint(2) unsigned")
                .HasColumnName("tertiary_skill");
        });
